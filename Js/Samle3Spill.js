...
window.onload = function() {
    ...
    // Gui buttons
    var buttons = [ { x: 30, y: 240, width: 150, height: 50, text: "Nytt Spill"},
                    { x: 30, y: 300, width: 150, height: 50, text: "Vis trekk"},
                    { x: 30, y: 360, width: 150, height: 50, text: "Aktiver AI Bot"}];
    ...
    function render() {
        ...
        drawCenterText("Poengsum:", 30, level.y+40, 150);
        ...
        if (gameover) {
            ...
            context.font = "24px Verdana";
            drawCenterText("Spillet er ferdig!", level.x, level.y + levelheight / 2 + 10, levelwidth);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Samle 3 eller mer av samme farge", 10, 30);
