...
window.onload = function() {
    ...
    function render() {
        ...
        drawCenterText("Poengsum:", scorex, scorey, 150);
        ...
        if (gamestate == gamestates.gameover) {
            ...
            context.fillStyle = "#ffffff";
            context.font = "24px Verdana";
            drawCenterText("Spillet er ferdig!", level.x, level.y + level.height / 2 + 10, level.width);
            drawCenterText("Trykk for å starte", level.x, level.y + level.height / 2 + 40, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Bobble Skyter Spill", 10, 37);
